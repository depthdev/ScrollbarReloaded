...
(function(window) {
  ...
  window.MouseTouchScroll = function(devObj) {
    ...
    function $$mouseTouchScroll(instance, masterNamespace) {
      ...
      function _reset() {
        ...
        // Ignore tracks?
        $this.x.ignore = $this.instance.getAttribute('mouse-touch-scroll-x') === 'false' ? true : false;
        $this.y.ignore = $this.instance.getAttribute('mouse-touch-scroll-y') === 'false' ? true : false;
      } // _reset();
      ...
      function _setListeners() {
        ...
        $this.x.train.addEventListener('mousedown', function(e) {
          ...
          $this.x.track.setAttribute('mouse-touch-scroll-x-track', 'active');
        ...
        $this.y.train.addEventListener('mousedown', function(e) {
          ...
          $this.y.track.setAttribute('mouse-touch-scroll-y-track', 'active');
        });
        ...
        $listenerClosures.mouseup = function(e) {
          ...
          $this.x.track.setAttribute('mouse-touch-scroll-x-track', '');
          $this.y.track.setAttribute('mouse-touch-scroll-y-track', '');
        };
      ...
      function _update(xPercent, yPercent) {
        ...
        $this.instance.appendChild($this.y.track);
          ...
          // Scroll type
          (function() {
            const scrollType = $this.instance.getAttribute('mouse-touch-scroll-type');
    ...
    function $$bootstrap() {
      Array.prototype.slice.call(document.querySelectorAll('[' + $$ns + ']:not([' + $$prefix + 'bootstrapped])')).forEach(function(e) {
        const namespace = e.getAttribute('mouse-touch-scroll');
        if (namespace.length) {
          ...
          if (/master/.test(namespace)) {
            $$bootstrappedInstances.default.push(new $$mouseTouchScroll(e, label));
          } else {
            $$bootstrappedInstances[label].push(new $$mouseTouchScroll(e));
          }
        } else {
          $$bootstrappedInstances.default.push(new $$mouseTouchScroll(e));
        }
      });
    } // $$bootstrap;
